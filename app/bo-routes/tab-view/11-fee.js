...
router.get('/current-service/back-office/tab-view/11-fee', function(req, res) {
  ...
  // Render the page
  res.render('current-service/back-office/tab-view/11-fee', { 
...
router.post('/publish-status-answer-11-fee', function (req, res) {
  const foundCase = getCase(req);
  ...
  if (foundCase.publishStatus !== "Yes") {
    ...
    if (!hasAddress && !hasCoords) {
      return res.render('current-service/back-office/tab-view/11-fee', {
        currentCase: foundCase,
